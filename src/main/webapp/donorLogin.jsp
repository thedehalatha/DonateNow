...
<title>DonateNow — Donor Login</title>
<link href="https://fonts.googleapis.com/css2?family=Syne:wght@700;800&family=DM+Sans:wght@300;400;500&display=swap" rel="stylesheet">
<style>
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
:root{--bg:#0a0a0f;--surface:#13131a;--surface2:#1c1c26;--border:rgba(255,255,255,0.07);--green:#22c55e;--text:#f1f0ee;--muted:#6b6a72;--red:#ef4444}
...
body::before{content:'';position:fixed;inset:0;background-image:linear-gradient(rgba(34,197,94,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(34,197,94,0.03) 1px,transparent 1px);background-size:40px 40px;pointer-events:none}
body::after{content:'';position:fixed;top:-200px;left:-200px;width:500px;height:500px;background:radial-gradient(circle,rgba(34,197,94,0.08) 0%,transparent 70%);pointer-events:none}
...
.icon{width:56px;height:56px;background:rgba(34,197,94,0.12);border:1px solid rgba(34,197,94,0.2);border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:26px;margin-bottom:24px}
...
input:focus{border-color:rgba(34,197,94,0.5)}
.btn{width:100%;padding:13px;background:var(--green);color:#000;border:none;border-radius:10px;font-family:'DM Sans',sans-serif;font-size:15px;font-weight:500;cursor:pointer;transition:all 0.2s;margin-top:4px}
...
<div class="wrap">
  ...
  <div class="card">
    <div class="icon">&#x1F91C;</div>
    <h1>Donor Login</h1>
    <p class="sub">Login to register your donation offer</p>
    ...
    <form method="post" action="donorLoginAction">
      <label>Username</label>
      <input type="text" name="username" placeholder="Enter donor username" required/>
      <label>Password</label>
      <input type="password" name="password" placeholder="Enter password" required/>
      <button type="submit" class="btn">Login as Donor &rarr;</button>
    </form>
    <p class="hint">Default: username <span>donor</span> &nbsp;/&nbsp; password <span>donor123</span></p>
  </div>
</div>
</body>
</html>
